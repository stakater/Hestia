...
func (in *RunnerStatus) DeepCopyInto(out *RunnerStatus) {
	*out = *in
	...
	if in.RunnerGeneration != nil {
		in, out := &in.RunnerGeneration, &out.RunnerGeneration
		*out = make(map[string]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.DeploymentsGeneration != nil {
		in, out := &in.DeploymentsGeneration, &out.DeploymentsGeneration
		*out = make(map[string]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
